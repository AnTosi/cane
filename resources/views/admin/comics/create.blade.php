...
@section('content')
    <div class="container m-3">
        ...
        <form action="{{route('admin.comics.store')}}" method="post">
            ...
            {{-- add title --}}
            <div class="mb-3">
                <label for="title" class="form-label">Add a new Comic</label>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('thumb') url is invalid @enderror" name="thumb" id="thumb" aria-describedby="thumbHelper" placeholder="Insert here the link to the image">
